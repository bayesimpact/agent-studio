...
No additional credentials or env vars needed. All GCP services auto-authenticate via the Cloud Run service account (`connect-api@caseai-connect.iam.gserviceaccount.com`).
