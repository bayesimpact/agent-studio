...
describe("ConversationAgentSessionsRoutes.getAllPlaygroundSessions", () => {
  ...
  const createContext = async () => {
    ...
    const oldestPlaygroundSession = conversationAgentSessionFactory
      .transient({
        organization,
        project,
        user,
    ...
    const newestPlaygroundSession = conversationAgentSessionFactory
      .transient({
        organization,
        project,
        user,
    ...
    const appPrivateSession = conversationAgentSessionFactory
      .transient({
        organization,
        project,
        user,
    ...
    const anotherUserPlaygroundSession = conversationAgentSessionFactory
      .transient({
        organization,
        project,
        user: anotherUser,
