...
describe("Auth0UserProvisioningService", () => {
  ...
  describe("findOrCreateUserByEmail", () => {
    ...
    it("should create user when no user exists", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith("https://bayes-impact.eu.auth0.com/api/v2/users", {
        method: "POST",
        headers: {
  ...
  describe("ensureUserInDefaultOrganization", () => {
    it("should add member to default organization", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        "https://bayes-impact.eu.auth0.com/api/v2/organizations/org_test/members",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  describe("sendPasswordResetEmail", () => {
    it("should call change_password endpoint", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        "https://bayes-impact.eu.auth0.com/dbconnections/change_password",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
