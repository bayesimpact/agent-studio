...
describe("EvaluationExtractionDatasets - createOne", () => {
  ...
  const subject = async (payload?: typeof EvaluationExtractionDatasetsRoutes.createOne.request) =>
    request({
  ...
  it("should create a dataset with valid name", async () => {
    ...
    await expectActivityCreated("evaluationExtractionDataset.create")
  })
