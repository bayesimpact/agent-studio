...
describe("EvaluationDatasets - Auth", () => {
  ...
  describe("EvaluationDatasetsRoutes.getAll", () => {
    const subject = async () =>
      request({
        route: EvaluationDatasetsRoutes.getAll,
  ...
  describe("EvaluationDatasetsRoutes.getAllFiles", () => {
    const subject = async () =>
      request({
        route: EvaluationDatasetsRoutes.getAllFiles,
        pathParams: removeNullish({ organizationId, projectId }),
        token: accessToken ?? undefined,
      })
  ...
  describe("EvaluationDatasetsRoutes.getFileColumns", () => {
    const subject = async () =>
      request({
  ...
  describe("EvaluationDatasetsRoutes.createOne", () => {
    const payload: typeof EvaluationDatasetsRoutes.createOne.request = {
      payload: { name: "Test Dataset" },
    }

    const subject = async (requestPayload?: typeof EvaluationDatasetsRoutes.createOne.request) =>
      request({
  ...
  describe("EvaluationDatasetsRoutes.updateOne", () => {
    const payload: typeof EvaluationDatasetsRoutes.updateOne.request = {
      payload: { name: "Updated Dataset", columns: [] },
    }

    const subject = async (requestPayload?: typeof EvaluationDatasetsRoutes.updateOne.request) =>
      request({
