...
import { EvaluationDatasetPolicy } from "./evaluation-dataset.policy"

@Injectable()
export class EvaluationDatasetGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const policy = new EvaluationDatasetPolicy(
