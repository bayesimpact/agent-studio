...
export class AddOrganizationIdAndProjectIdNullable1770736967169 implements MigrationInterface {
  name = "AddOrganizationIdAndProjectIdNullable1770736967169"

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "document" ADD "organization_id" uuid`)
    await queryRunner.query(`ALTER TABLE "agent" ADD "organization_id" uuid`)
    await queryRunner.query(`ALTER TABLE "agent_message" ADD "organization_id" uuid`)
    await queryRunner.query(`ALTER TABLE "agent_message" ADD "project_id" uuid`)
    await queryRunner.query(`ALTER TABLE "agent_session" ADD "project_id" uuid`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "agent_session" DROP COLUMN "project_id"`)
    await queryRunner.query(`ALTER TABLE "agent_message" DROP COLUMN "project_id"`)
    await queryRunner.query(`ALTER TABLE "agent_message" DROP COLUMN "organization_id"`)
    await queryRunner.query(`ALTER TABLE "agent" DROP COLUMN "organization_id"`)
    await queryRunner.query(`ALTER TABLE "document" DROP COLUMN "organization_id"`)
  }
}
