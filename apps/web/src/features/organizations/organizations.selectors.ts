...
export const selectCurrentOrganizationName = (organizationId?: string) => (state: RootState) =>
  state.organizations.organizations.find((org) => org.id === organizationId)?.name || null
