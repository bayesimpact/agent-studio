    ...
    <>
      <div className="flex items-center justify-end">
        ...
        >
          ...
          {advancedMode
            ? t("agentSettings:props.schemaBuilder.visualMode")
            : t("agentSettings:props.schemaBuilder.advancedMode")}
        </Button>
      </div>
                ...
                setEditor((previous) => ({
                  ...
                  jsonError: validationResult.success
                    ...
                    : (validationResult.error.issues.at(0)?.message ??
                      t("agentSettings:props.validation.outputJsonSchemaInvalid")),
                }))
              } catch {
                onChange(raw)
                setEditor((previous) => ({
                  ...previous,
                  jsonError: t("agentSettings:props.validation.outputJsonSchemaInvalid"),
                }))
              }
            }}
          />
