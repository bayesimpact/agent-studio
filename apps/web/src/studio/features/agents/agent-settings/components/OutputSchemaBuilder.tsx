  ...
  const columns = useMemo<ColumnDef<SchemaField>[]>(
    () => [
        ...
        ? ([
            {
              id: "drag",
              header: () => (
                <span className="sr-only">{t("agentSettings:props.schemaBuilder.dragHandle")}</span>
              ),
        ...
        : []),
      {
        ...
        header: () => (
          <span className="text-muted-foreground">
            {t("agentSettings:props.schemaBuilder.fieldName")}
          </span>
        ),
      ...
      },
      {
        ...
        header: () => (
          <span className="text-muted-foreground">
            {t("agentSettings:props.schemaBuilder.type")}
          </span>
        ),
      ...
      },
      {
        ...
        header: () => (
          <span className="text-muted-foreground">
            {t("agentSettings:props.schemaBuilder.required")}
          </span>
        ),
        ...
        cell: ({ row, table }) => {
          ...
          return (
            <Switch
              ...
              disabled={meta.disabled}
              aria-label={t("agentSettings:props.schemaBuilder.required")}
      ...
      },
      {
        ...
        header: () => (
          <span className="text-muted-foreground">
            {t("agentSettings:props.schemaBuilder.description")}
          </span>
        ),
      ...
      },
      {
        id: "actions",
        header: () => (
          <span className="sr-only">{t("agentSettings:props.schemaBuilder.removeField")}</span>
        ),
        ...
        cell: ({ row, table }) => {
          ...
          return (
            <Button
              ...
              aria-label={t("agentSettings:props.schemaBuilder.removeField")}
    ...
    <div className="flex flex-col gap-3">
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex flex-col gap-0.5">
            <Label htmlFor="schema-ordering" className="font-medium text-sm">
              {t("agentSettings:props.schemaBuilder.orderQuestions")}
            </Label>
            <p className="text-muted-foreground text-xs">
              {t("agentSettings:props.schemaBuilder.orderQuestionsHint")}
            </p>
          </div>
        </div>
      )}
      ...
      {fields.length === 0 ? (
        <p className="rounded-md border border-dashed p-6 text-center text-muted-foreground text-sm">
          {t("agentSettings:props.schemaBuilder.empty")}
        </p>
      ) : (
        <DndContext
          sensors={sensors}
      ...
      >
        <PlusIcon /> {t("agentSettings:props.schemaBuilder.addField")}
      </Button>
    </div>
  )
}
...
function RowDragHandleCell({ rowId, disabled }: { rowId: string; disabled: boolean }) {
  ...
  return (
    <button
      type="button"
      aria-label={t("agentSettings:props.schemaBuilder.dragHandle")}
      disabled={disabled}
          ...
          {FIELD_TYPES.map((type) => {
            ...
            return (
              <SelectItem key={type} value={type}>
                ...
                {t(`agentSettings:props.schemaBuilder.types.${type}`)}
              </SelectItem>
            )
          })}
        </SelectContent>
...
function NumberRangeEditor({
  ...
  let label = t("agentSettings:props.schemaBuilder.rangeEmpty")
  if (minimum !== undefined && maximum !== undefined) {
    label = t("agentSettings:props.schemaBuilder.rangeBoth", { min: minimum, max: maximum })
  } else if (minimum !== undefined) {
    label = t("agentSettings:props.schemaBuilder.rangeMinOnly", { min: minimum })
  } else if (maximum !== undefined) {
    label = t("agentSettings:props.schemaBuilder.rangeMaxOnly", { max: maximum })
  }
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="start" className="flex w-72 flex-col gap-2">
        <div className="flex items-start gap-2">
          <div className="flex flex-1 flex-col gap-1">
            <Label className="text-muted-foreground text-xs">
              {t("agentSettings:props.schemaBuilder.rangeMin")}
            </Label>
            <Input
              type="number"
              value={minimum ?? ""}
              disabled={disabled}
              aria-label={t("agentSettings:props.schemaBuilder.rangeMin")}
              className="h-8"
          ...
          <div className="flex flex-1 flex-col gap-1">
            <Label className="text-muted-foreground text-xs">
              {t("agentSettings:props.schemaBuilder.rangeMax")}
            </Label>
            <Input
              type="number"
              value={maximum ?? ""}
              disabled={disabled}
              aria-label={t("agentSettings:props.schemaBuilder.rangeMax")}
              className="h-8"
        ...
        <p className="text-muted-foreground text-xs">
          {t("agentSettings:props.schemaBuilder.rangeHint")}
        </p>
      </PopoverContent>
    </Popover>
  )
  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        ...
        >
          {values.length > 0
            ? t("agentSettings:props.schemaBuilder.enumValues", { count: values.length })
            : t("agentSettings:props.schemaBuilder.enumValuesEmpty")}
        </button>
      </PopoverTrigger>
      <PopoverContent align="start" className="flex w-72 flex-col gap-2">
        {values.length > 0 && (
            ...
            {values.map((value, index) => (
              ...
              >
                ...
                <Button
                  ...
                  size="icon-sm"
                  disabled={disabled}
                  aria-label={t("agentSettings:props.schemaBuilder.enumValueRemove", { value })}
        ...
        <div className="flex items-center gap-1">
          <Input
            ...
            value={draft}
            disabled={disabled}
            aria-label={t("agentSettings:props.schemaBuilder.enumValueAdd")}
            placeholder={t("agentSettings:props.schemaBuilder.enumValuesPlaceholder")}
            className="h-8"
        ...
        <p className="text-muted-foreground text-xs">
          {t("agentSettings:props.schemaBuilder.enumValuesHint")}
        </p>
      </PopoverContent>
    </Popover>
  )
    ...
    <Popover>
        ...
        >
          {field.name ? (
            ...
            <span className="font-normal text-muted-foreground italic">
              {t("agentSettings:props.schemaBuilder.fieldNameEmpty")}
            </span>
          )}
        </button>
      </PopoverTrigger>
      <PopoverContent align="start" className="w-80">
        <Input
          autoFocus
          value={field.name}
          aria-label={t("agentSettings:props.schemaBuilder.fieldName")}
          placeholder={t("agentSettings:props.schemaBuilder.fieldNamePlaceholder")}
    ...
    <>
      <Popover>
          ...
          >
            {field.description ? (
              ...
              <span className="text-muted-foreground italic">
                {t("agentSettings:props.schemaBuilder.descriptionEmpty")}
              </span>
            )}
          </button>
        </PopoverTrigger>
        <PopoverContent align="start" className="flex w-96 flex-col gap-2">
          <Textarea
            ...
            rows={5}
            aria-label={t("agentSettings:props.schemaBuilder.description")}
            placeholder={t("agentSettings:props.schemaBuilder.descriptionPlaceholder")}
          ...
          >
            <Maximize2Icon /> {t("agentSettings:props.schemaBuilder.expandDescription")}
          </Button>
        </PopoverContent>
      </Popover>
      ...
      <Dialog open={expanded} onOpenChange={setExpanded}>
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {field.name || t("agentSettings:props.schemaBuilder.description")}
            </DialogTitle>
          </DialogHeader>
          <Textarea
            autoFocus
