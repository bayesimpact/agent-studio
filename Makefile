...
trivy-scan: docker-build
	trivy image --ignore-unfixed --vuln-type os,library --severity CRITICAL,HIGH ${apiImageUrl}
	trivy image --ignore-unfixed --vuln-type os,library --severity CRITICAL,HIGH ${workersImageUrl}
